        ...
        <div className={styles.layout}>
          ...
          <div className={styles.productWrapper}>
            ...
            <div className={styles.gallery}>
              ...
              >
                <img
                  src={allImages[activeImage] || '/logo.png'}
                  alt={product.title}
                />
              ...
              <div className={styles.form}>
                {product.variants.map((variantGroup) => (
                  <VariantSelector
                    ...
                    onChange={(optionId) =>
                      handleVariantChange(variantGroup.id, optionId)
                    }
                  />
                ))}
                ...
                <div className={styles.trustItem}>
                  ...
                  <span>
                    {product.freeShipping
                      ...
                      : 'Envío rápido a domicilio a todo el país'}
                  </span>
                </div>
                <div className={styles.trustItem}>
                  <ShieldCheck className={styles.trustIcon} size={20} />
                  <span>
                    Garantía oficial de fábrica en acero{' '}
                    {product.material || 'AISI 430'}
                  </span>
                </div>
              </div>
            </div>
